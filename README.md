...
- 🗣️ **Le sexe oral n'est jamais obligatoire** : ni la fellation ni le cunnilingus ne sont forcés durant une séance, même quand les deux partenaires les ont autorisés dans le questionnaire de limites — le tirage reste aléatoire. Chacun n'est de toute façon proposé qu'**une seule fois par personne** sur toute la phase Préliminaires, puis à nouveau une seule fois sur toute la phase Intense (jamais répété en boucle).
