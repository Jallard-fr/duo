...
- **Chronomètre** intégré, avec une durée aléatoire dans la plage définie pour chaque activité (ou personnalisable), avec des bips sonores dans la carte (toutes les 30 s, puis un bip différent chaque seconde dans les 10 dernières secondes) — désactivables via le bouton 🔊/🔇 de la carte.
- **Activités courtes** : chaque activité dure au maximum 3 minutes (souvent moins), ou est quantifiée en nombre d'actions plutôt qu'en temps (ex. "10 baisers", "20 mouvements de massage") — pour enchaîner sans que rien ne s'éternise et casser la routine.
